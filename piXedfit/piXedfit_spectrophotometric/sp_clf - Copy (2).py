...
#	align_map_mask, footprint = reproject_exact((map_mask,header_califa2D), header_stamp_image)
	...
	unit_ifu_new = 1.0e-20          # in erg/s/cm^2/Ang.
	map_specphoto_spec_flux = np.transpose(map_specphoto_spec_flux0, axes=(2, 0, 1))/unit_ifu_new #*unit_ifu/unit_ifu_new
	map_specphoto_spec_flux_err = np.transpose(map_specphoto_spec_flux_err0, axes=(2, 0, 1))/unit_ifu_new #*unit_ifu/unit_ifu_new
