...
__all__ = ["sort_filters", "kpc_per_pixel", "k_lmbd_Fitz1986_LMC", "EBV_foreground_dust", "dwd_sdss", "dwd_2mass",
	   ...
	   "raise_errors", "get_img_pixsizes","get_img_pixsizes_hst", "in_kernels", "get_flux_or_sb", "crop_2D_data"]
...
def unknown_images(filters):
	list_filters = ['galex_fuv', 'galex_nuv', 'sdss_u', 'sdss_g', 'sdss_r', 'sdss_i',
					'sdss_z', '2mass_j', '2mass_h', '2mass_k','hst_wfc3_uvis_f275w','hst_wfc3_uvis2_f336w', 'hst_acs_f475w','hst_wfpc3_f555w','hst_acs_f606w','hst_wfpc2_f606w','hst_wfpc3_f775w','hst_acs_f814w','hst_wfpc2_f814w','hst_wfpc3_f814w','spitzer_irac_36', 'spitzer_irac_45',
...
def check_avail_kernel(filter_init=None, filter_final=None):
	filters_def = ['galex_fuv', 'galex_nuv', 'sdss_u', 'sdss_g', 'sdss_r', 'sdss_i', 'sdss_z','hst_wfc3_uvis_f275w', 'hst_wfc3_uvis2_f336w','hst_acs_f475w','hst_wfpc3_f555w','hst_acs_f606w','hst_wfpc2_f606w','hst_wfpc3_f775w','hst_acs_f814w','hst_wfpc3_f814w','hst_wfpc2_f814w', '2mass_j', '2mass_h', '2mass_k',
...
def get_psf_fwhm(filters=[]):
	...
	col_fwhm_psf['hst_wfc3_uvis_f275w'] = 0.09
	col_fwhm_psf['hst_acs_f475w'] = 0.09
	col_fwhm_psf['hst_wfpc2_f606w'] = 0.09
	col_fwhm_psf['hst_wfpc3_f555w'] = 0.09
	col_fwhm_psf['hst_wfpc3_f775w'] = 0.09
	col_fwhm_psf['hst_wfpc2_f814w'] = 0.09
	col_fwhm_psf['hst_wfpc3_f814w'] = 0.09
	col_fwhm_psf['hst_wfc3_uvis2_f336w'] = 0.09

	col_fwhm_psf['hst_acs_f814w'] = 0.09
...
def calc_pixsize_hst(fits_image):
   from astropy.wcs.utils import proj_plane_pixel_area
   from astropy.wcs import WCS
   from astropy.wcs import wcs
	...
	if img_pixsizes is not None:
		for bb in range(0,len(filters)):
			...
			#		if filters[bb]=='hst_acs_f475w':
					...
					img_pixsizes1[filters[bb]] = calc_pixsize(sci_img[filters[bb]],filters)
			#		else :
		...
		for bb in range(0,len(filters)):
			if flag_psfmatch==1 and flag_reproject==1 and flux_or_sb[filters[bb]]==0:
				...
				if filters[bb]=='hst_wfc3_uvis_f275w'or filters[bb]=='hst_acs_f475w'or filters[bb]=='hst_wfc3_uvis2_f336w' or filters[bb]=='hst_wfpc2_f606w'or filters[bb]=='hst_wfpc2_f814w'or filters[bb]=='hst_wfpc3_f814w' or filters[bb]=='hst_wfpc3_f555w'or filters[bb]=='hst_wfpc3_f775w':

					img_pixsizes1[filters[bb]] = calc_pixsize_hst(sci_img[filters[bb]])
				else :
					img_pixsizes1[filters[bb]] = calc_pixsize(sci_img[filters[bb]])

	return img_pixsizes1

def get_img_pixsizes_hst(img_pixsizes,filters,sci_img,flux_or_sb,flag_psfmatch,flag_reproject):
...
def get_flux_or_sb(filters,img_unit):
	...
	flux_or_sb0['hst_wfc3_uvis_f275w'] = 0
	flux_or_sb0['hst_wfc3_uvis2_f336w'] = 0

	flux_or_sb0['hst_acs_f475w'] = 0
	flux_or_sb0['hst_acs_f814w'] = 0
	flux_or_sb0['hst_wfpc2_f606w'] = 0
	flux_or_sb0['hst_wfpc3_f555w'] = 0
	flux_or_sb0['hst_wfpc3_f775w'] = 0
	flux_or_sb0['hst_wfpc2_f814w'] = 0
	flux_or_sb0['hst_wfpc3_f814w'] = 0
