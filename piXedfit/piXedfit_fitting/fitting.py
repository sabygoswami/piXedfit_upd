...
def singleSEDfit(obs_flux,obs_flux_err,filters,models_spec,params_ranges=None,params_priors=None,fit_method='mcmc',
	...
	if fit_method=='mcmc' or fit_method=='MCMC':
		...
		os.system("mpirun -n %d python3 %s./mc_p1.py %s %s %s %s" % (nproc,CODE_dir,name_filters_list,name_config,
		...
		if store_full_samplers==1 or store_full_samplers==True:
			os.system("mpirun -n %d python3 %s./mc_p2.py %s %s %s %s" % (nproc_new,CODE_dir,name_filters_list,name_config,
																		name_samplers_hdf5,name_out_fits))
		elif store_full_samplers==0 or store_full_samplers==False:
			os.system("mpirun -n %d python3 %s./mc_nsmp_p2.py %s %s %s %s" % (nproc_new,CODE_dir,name_filters_list,name_config,
																			name_samplers_hdf5,name_out_fits))
		else:
		...
		if store_full_samplers==1 or store_full_samplers==True:
			if free_z==0:
				os.system("mpirun -n %d python3 %s./rd_fz.py %s %s %s %s" % (nproc_new,CODE_dir,name_filters_list,name_config,
																			name_SED_txt,name_out_fits))
			elif free_z==1:
				os.system("mpirun -n %d python3 %s./rd_vz.py %s %s %s %s" % (nproc_new,CODE_dir,name_filters_list,name_config,
																			name_SED_txt,name_out_fits))
		elif store_full_samplers==0 or store_full_samplers==False:
			if free_z==0:
				os.system("mpirun -n %d python3 %s./rd_fz_nsmp.py %s %s %s %s" % (nproc_new,CODE_dir,name_filters_list,name_config,
																				name_SED_txt,name_out_fits))
			elif free_z==1:
				os.system("mpirun -n %d python3 %s./rd_vz_nsmp.py %s %s %s %s" % (nproc_new,CODE_dir,name_filters_list,name_config,
																				name_SED_txt,name_out_fits))
		else:
			print ("Input store_full_samplers not recognized!")
			sys.exit()
...
def singleSEDfit_specphoto(obs_flux,obs_flux_err,filters,spec_wave,spec_flux,spec_flux_err,models_spec,
	...
	if fit_method=='mcmc' or fit_method=='MCMC':
		...
		os.system("mpirun -n %d python3 %s./mc_p1_sp.py %s %s %s %s" % (nproc,CODE_dir,name_filters_list,name_config,
																		inputSED_file,name_samplers_hdf5))
		os.system('mv %s %s' % (name_samplers_hdf5,temp_dir))
		
		if store_full_samplers==1 or store_full_samplers==True:
			os.system("mpirun -n %d python3 %s./mc_p2_sp.py %s %s %s %s" % (nproc_new,CODE_dir,name_filters_list,name_config,
																			name_samplers_hdf5,name_out_fits))
		elif store_full_samplers==0 or store_full_samplers==False:
			os.system("mpirun -n %d python3 %s./mc_nsmp_p2_sp.py %s %s %s %s" % (nproc_new,CODE_dir,name_filters_list,name_config,
																				name_samplers_hdf5,name_out_fits))
		else:
			print ("Input store_full_samplers not recognized!")
			sys.exit()
		...
		if store_full_samplers==1 or store_full_samplers==True:
			if free_z==0:
				os.system("mpirun -n %d python3 %s./rd_fz_sp.py %s %s %s %s" % (nproc_new,CODE_dir,name_filters_list,name_config,
																				inputSED_file,name_out_fits))
			elif free_z==1:
				os.system("mpirun -n %d python3 %s./rd_vz_sp.py %s %s %s %s" % (nproc_new,CODE_dir,name_filters_list,name_config,
																				inputSED_file,name_out_fits))
		elif store_full_samplers==0 or store_full_samplers==False:
			if free_z==0:
				os.system("mpirun -n %d python3 %s./rd_fz_nsmp_sp.py %s %s %s %s" % (nproc_new,CODE_dir,name_filters_list,name_config,
																				inputSED_file,name_out_fits))
			elif free_z==1:
				os.system("mpirun -n %d python3 %s./rd_vz_nsmp_sp.py %s %s %s %s" % (nproc_new,CODE_dir,name_filters_list,name_config,
																				inputSED_file,name_out_fits))
		else:
			print ("Input store_full_samplers not recognized!")
			sys.exit()
	...
	for idx_bin in bin_ids:
		...
		if np.sum(bin_spec_flux[int(idx_bin)])>0:
			...
			if fit_method=='mcmc' or fit_method=='MCMC':
				...
				os.system("mpirun -n %d python3 %s./mc_p1_sp.py %s %s %s %s" % (nproc,CODE_dir,name_filters_list,name_config,inputSED_file,name_samplers_hdf5))
				os.system('mv %s %s' % (name_samplers_hdf5,temp_dir))
				
				if store_full_samplers==1 or store_full_samplers==True:
					os.system("mpirun -n %d python3 %s./mc_p2_sp.py %s %s %s %s" % (nproc_new,CODE_dir,name_filters_list,name_config,name_samplers_hdf5,name_out_fits1))
				elif store_full_samplers==0 or store_full_samplers==False:
					os.system("mpirun -n %d python3 %s./mc_nsmp_p2_sp.py %s %s %s %s" % (nproc_new,CODE_dir,name_filters_list,name_config,name_samplers_hdf5,name_out_fits1))
				else:
					print ("Input store_full_samplers not recognized!")
					sys.exit()
				os.system("rm %s%s" % (temp_dir,name_samplers_hdf5))
				...
				if store_full_samplers==1 or store_full_samplers==True:
					if free_z==0:
						os.system("mpirun -n %d python3 %s./rd_fz_sp.py %s %s %s %s" % (nproc_new,CODE_dir,name_filters_list,name_config,inputSED_file,name_out_fits1))
					elif free_z==1:
						os.system("mpirun -n %d python3 %s./rd_vz_sp.py %s %s %s %s" % (nproc_new,CODE_dir,name_filters_list,name_config,inputSED_file,name_out_fits1))
				elif store_full_samplers==0 or store_full_samplers==False:
					if free_z==0:
						os.system("mpirun -n %d python3 %s./rd_fz_nsmp_sp.py %s %s %s %s" % (nproc_new,CODE_dir,name_filters_list,name_config,inputSED_file,name_out_fits1))
					elif free_z==1:
						os.system("mpirun -n %d python3 %s./rd_vz_nsmp_sp.py %s %s %s %s" % (nproc_new,CODE_dir,name_filters_list,name_config,inputSED_file,name_out_fits1))
				else:
					print ("Input store_full_samplers not recognized!")
					sys.exit()
			else:
		...
		# photometric SED
			...
			if fit_method=='mcmc' or fit_method=='MCMC':
				name_samplers_hdf5 = randname("samplers_",".hdf5")
				os.system("mpirun -n %d python3 %s./mc_p1.py %s %s %s %s" % (nproc,CODE_dir,name_filters_list,name_config,name_SED_txt,name_samplers_hdf5))
				os.system('mv %s %s' % (name_samplers_hdf5,temp_dir))
				if store_full_samplers==1 or store_full_samplers==True:
					os.system("mpirun -n %d python3 %s./mc_p2.py %s %s %s %s" % (nproc_new,CODE_dir,name_filters_list,name_config,name_samplers_hdf5,name_out_fits1))
				elif store_full_samplers==0 or store_full_samplers==False:
					os.system("mpirun -n %d python3 %s./mc_nsmp_p2.py %s %s %s %s" % (nproc_new,CODE_dir,name_filters_list,name_config,name_samplers_hdf5,name_out_fits1))
				else:
					print ("Input store_full_samplers not recognized!")
					sys.exit()
				...
				if store_full_samplers==1 or store_full_samplers==True:
					if free_z==0:
						os.system("mpirun -n %d python3 %s./rd_fz.py %s %s %s %s" % (nproc_new,CODE_dir,name_filters_list,name_config,name_SED_txt,name_out_fits1))
					elif free_z==1:
						os.system("mpirun -n %d python3 %s./rd_vz.py %s %s %s %s" % (nproc_new,CODE_dir,name_filters_list,name_config,name_SED_txt,name_out_fits1))
				elif store_full_samplers==0 or store_full_samplers==False:
					if free_z==0:
						os.system("mpirun -n %d python3 %s./rd_fz_nsmp.py %s %s %s %s" % (nproc_new,CODE_dir,name_filters_list,name_config,name_SED_txt,name_out_fits1))
					elif free_z==1:
						os.system("mpirun -n %d python3 %s./rd_vz_nsmp.py %s %s %s %s" % (nproc_new,CODE_dir,name_filters_list,name_config,name_SED_txt,name_out_fits1))
				else:
					print ("Input store_full_samplers not recognized!")
					sys.exit()
...
def SEDfit_from_binmap(fits_binmap,binid_range=None,bin_ids=None,models_spec=None,params_ranges=None,params_priors=None,
	...
	if fit_method=='mcmc' or fit_method=='MCMC':
		...
		# multiple bins
			...
			if store_full_samplers==1 or store_full_samplers==True:
				if free_z==0:
					os.system("mpirun -n %d python3 %s./rd_fz_blk.py %s %s %s %s" % (nproc_new,CODE_dir,name_filters_list,name_config,
																					name_inputSEDs,name_outs))
				elif free_z==1:
					os.system("mpirun -n %d python3 %s./rd_vz_blk.py %s %s %s %s" % (nproc_new,CODE_dir,name_filters_list,name_config,
																					name_inputSEDs,name_outs))

			elif store_full_samplers==0 or store_full_samplers==False:
				if free_z==0:
					os.system("mpirun -n %d python3 %s./rd_fz_nsmp_blk.py %s %s %s %s" % (nproc_new,CODE_dir,name_filters_list,name_config,
																						name_inputSEDs,name_outs))
				elif free_z==1:
					os.system("mpirun -n %d python3 %s./rd_vz_nsmp_blk.py %s %s %s %s" % (nproc_new,CODE_dir,name_filters_list,name_config,
																						name_inputSEDs,name_outs))
			else:
				print ("Input store_full_samplers not recognized!")
				sys.exit()
